...
Examples =
{
	...
	fireball :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( '/ship/textures/smokeparticle.png' ),
	...
	snow :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( '/ship/textures/snowflake.png' ),
	...
	rain :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( '/ship/textures/raindrop2flip.png' ),
	...
	starfield :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( '/ship/textures/spikey.png' ),
	...
	fireflies :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( '/ship/textures/spark.png' ),
	...
	{
		positionStyle  : Type.SPHERE,
		positionBase   : new THREE.Vector3( -2.75, 0.4, 0 ),
		positionRadius : 0.1,
		
		velocityStyle  : Type.CUBE,
		velocityBase   : new THREE.Vector3(-5,0,0),
		velocitySpread : new THREE.Vector3(2,1,1),
		
		particleTexture : THREE.ImageUtils.loadTexture( '/ship/textures/smokeparticle.png' ),
		
		sizeTween    : new Tween( [1, 1, 1], [5, 10, 10] ),
		opacityTween : new Tween( [1, 5], [1, 0] ),
		colorTween   : new Tween( [0.25, 1.0], [ new THREE.Vector3(0.02, 1, 0.5), new THREE.Vector3(0.05, 1, 0) ] ),
		blendStyle : THREE.AdditiveBlending,  
		
		particlesPerSecond : 20,
		particleDeathAge   : 2,		
		emitterDeathAge    : 2000
	}
