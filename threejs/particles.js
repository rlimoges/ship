...
Particle.prototype.update = function (dt) {
    ...
    if (this.emitter.colorTween.times.length > 0) {
        this.colorHSL = this.emitter.colorTween.lerp(this.age);
        this.color = new THREE.Color().setHSL(this.colorHSL.x, this.colorHSL.y, this.colorHSL.z);
    }

    if (this.emitter.opacityTween.times.length > 0)
        this.opacity = this.emitter.opacityTween.lerp(this.age);
}
