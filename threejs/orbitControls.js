...
THREE.OrbitControls = function (object, domElement) {
    ...
    this.update = function () {
        ...
        if (this.cameraMode == "zoomed") {
            // Follow target
            this.center = ship.target.mesh.position;
        ...
        this.enterZoom = function () {
            this.cameraMode = 'zoomed';
            scanState = true;
            this.minDistance = ship.target.orbital / 2;
            this.maxDistance = ship.target.orbital;

            $('.panel.scanInfo').show(1000);
            $('.btn.ok').show(0);
            $('.btn.scan').hide(250);
        };
